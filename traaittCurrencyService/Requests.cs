    ...
    class Request
    {
        ...
        public static JObject RPC(string Host, int Port, string Method, JObject Params = null, string Password = null)
        {
            ...
            try
            {
                ...
                if (Method != "getStatus" && traaittCurrencyService.logLevel >= 3) Console.WriteLine(Request);
                ...
                if (Method != "getStatus" && traaittCurrencyService.logLevel >= 3) Console.WriteLine(Result.ToString());
            ...
            {
                traaittCurrencyService.Log(2, "traaittCurrencyService", "Failed while sending request to host {0}: {1}", Host, e.Message);
            }
            return Result;
        }
        ...
        public static JObject GET(string Host)
        {
            ...
            {
                traaittCurrencyService.Log(2, "traaittCurrencyService", "Failed while fetching data from host {0}", Host);
            }
            return Result;
        }
    }
